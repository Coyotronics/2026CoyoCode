...
public class TurretFlywheel extends SubsystemBase {
  ...
  private final SmartMotorControllerConfig motorConfig = new SmartMotorControllerConfig(this)
      .withClosedLoopController(0.00016541, 0, 0, RPM.of(5000), RotationsPerSecondPerSecond.of(2500)) //kp, ki, kd, max rev/min, max rotations/s/s
  ...
  private final SmartMotorController motor = new SparkWrapper(flywheelMotor, DCMotor.getNeoVortex(1), motorConfig);
